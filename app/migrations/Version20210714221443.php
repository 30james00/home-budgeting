 ...
 */
final class Version20210714221443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE currency (id INT NOT NULL, name VARCHAR(60) NOT NULL, acronym VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
    }
